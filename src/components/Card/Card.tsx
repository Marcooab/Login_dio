...
import { CardContainer, ImageBackground, UserInfo, UserPicture, PostInfo, Content, HasInfo} from "./styles"
    ...
    <CardContainer>
        ...
        <Content>
            ...
            <PostInfo>
                ...
                <p>Projeto feito o curso de html e css no bootcamp dio do Gobal avanade...<strong>Saiba Mais</strong></p>
            </PostInfo>
            <HasInfo>
